...
En VScode se debe seleccionar el intérprete de Python, usando `ctrl+shift+p` (command palette) y escribiendo `Python interpreter`. En mi caso, selecciono un intérprete en un ambiente de `conda`.
